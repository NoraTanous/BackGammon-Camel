...
public class Moves extends LinkedList<RollMoves> implements InputValidator, ColorParser {
	...
	public void setQuestionAnsweredCorrectly(boolean isCorrect) {
	...
	public Move isValidPipToHome(String fro, String to) {
	    // Check if the question was answered correctly
	    if (!questionAnsweredCorrectly && LevelController.level.equals("Medium")) {
		//	infoPnl.print("You must answer the question correctly to make a move.", MessageType.ERROR);
	    }
