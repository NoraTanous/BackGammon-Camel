...
public class BoardComponents extends HBox {
	...
	protected Dices leftDices, rightDices, dices, diffDice;
	...
	private void initDices() {
		...
		if(LevelController.level.equals("Medium") || LevelController.level.equals("Hard")) {
			diffDice = new Dices(Color.RED);
		}
